...
function mostrarErrorInput(idInput, mensaje) {
  const input = document.getElementById(idInput);
  const feedback = input.nextElementSibling; // el div.invalid-feedback

  input.classList.add("is-invalid");   // hace que se muestre el mensaje
  feedback.innerText = mensaje;        // reemplaza el texto

  setTimeout(() => input.classList.remove("is-invalid"), 3000); // opcional: quitar la clase después de 3s
}
